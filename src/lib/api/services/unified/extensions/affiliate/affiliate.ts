...
export class UnifiedAffiliateService {
  ...
  async getAffiliateAccount(
    ...
    const response = await apiClient.get<AffiliateAccountListResponse>(
  ...
  async getAffiliateWithdrawals(
    ...
    const response = await apiClient.get<AffiliateWithdrawalListResponse>(
  ...
  async getAffiliateTransactions(
    ...
    const response = await apiClient.get<AffiliateTransactionListResponse>(
  ...
  async updateAffiliateWithdrawalStatus(
    ...
    const response = await apiClient.post<AffiliateWithdrawal>(
      `${this.basePath}/withdraw/${id}`,
    );
    return response.data!;
  }

  async getDefaultAffiliateCommissionRate(): Promise<AffiliateCommissionRate> {
    const response = await apiClient.get<AffiliateCommissionRate>(
  ...
  async updateDefaultAffiliateCommissionRate(
    ...
    const response = await apiClient.post<AffiliateCommissionRate>(
      `${this.basePath}/commission-rate`,
      { commissionRate },
    );
    return response.data!;
  ...
  async updateAffiliateCommissionRate(
    ...
    const response =
      await apiClient.post<AffiliateCommissionRateAccountResponse>(
